...
abstract class MenuItems implements Orderable,Discounts {
    ...
    private static int totalNumberOfOrder = 0;
    ...
    public static void setTotalNumberOfOrder(int totalNumberOfOrder) {
        MenuItems.totalNumberOfOrder = totalNumberOfOrder;
    }
...
class VegItems extends MenuItems {
    ...
    public void prepare() {
        ...
        setTotalNumberOfOrder(getTotalNumberOfOrder() + 1);
    }
}
...
class Orders {
    ...
    public void addItems(MenuItems items) {
        ...
        System.out.println("The Items Oredered is " + items.getName() + "The Price is " + items.getPrice());
    }
...
public class HungerBox {
    public static void main(String[] args) {
        System.out.println("  ╔═══════════════════════════════════╗");
        System.out.println("  ║       Welcome to Spicy Garden 🍕  ║");
        System.out.println("  ╚═══════════════════════════════════╝");
